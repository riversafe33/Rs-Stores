...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if Config.TiendaNPCActiva and npc and DoesEntityExist(npc) then
...
if Config.TiendaNPCActiva and (not npc or not DoesEntityExist(npc)) then
    Citizen.CreateThread(function()
        ...
        npc = Citizen.InvokeNative(0xD49F9B0955C367DE, model, x, y, z, heading, true, true, true, true)
...
function moverNPC()
    Citizen.CreateThread(function()
        while true do
            ...
            SetEntityCoords(npc, x, y, z, false, false, false, true)
...
AddEventHandler("onResourceStop", function(resourceName)
    if resourceName == GetCurrentResourceName() then
        ...
        for nombre, blip in pairs(tiendaBlips) do
            if blip then
                RemoveBlip(blip)
            end
        end
        ...
        for _, entidad in pairs(NpcShop) do
